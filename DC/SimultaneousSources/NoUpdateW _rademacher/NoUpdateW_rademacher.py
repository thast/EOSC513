...
dmisfitsub.append(dmis.eval(m0)/survey_r.nD)
print "Dmisfit compared to sub dataset: ",dmis.eval(m0)/survey_r.nD
print "Check sub misfit with true model: ",dmis.eval(mtrue)/survey_r.nD
...
np.save('./finalresult.npy',msimple)
