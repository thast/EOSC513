...
\begin{frame}{Recovered Models using sparse GN update}
\begin{itemize}
...
\begin{figure}
  ...
  \subfigure{\includegraphics[width=30mm]{figures/Convergence_Sparse_withW.png}}
\end{figure}
\end{frame}
...
\end{itemize}
\begin{figure}
  \subfigure{\includegraphics[width=59mm]{figures/SimSrc_kills_Sparsity_DCT.png}}
  \subfigure{\includegraphics[width=59mm]{figures/SimSrc_kills_Sparsity_Id.png}}
\end{figure}
